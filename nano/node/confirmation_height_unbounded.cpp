...
void nano::confirmation_height_unbounded::process (const std::shared_ptr<nano::block> & original_block)
{
	if (pending_empty ())
	{
		clear_process_vars ();
