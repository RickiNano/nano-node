...
bool nano::transport::tcp_channel::send_impl (nano::messages::message const & message, nano::shared_const_buffer const * buffer_a, nano::transport::traffic_type type, nano::transport::channel::callback_t callback)
{
