...
{
public:
	node (boost::asio::io_context &, uint16_t, std::filesystem::path const &, nano::logging const &, nano::work_pool &, const nano::node_flags & = nano::node_flags (), unsigned seq = 0);
...
public:
	...
	void work_generate (nano::work_version const, nano::root const &, uint64_t, const std::function<void (boost::optional<uint64_t>)> &, boost::optional<nano::account> const & = boost::none, bool const = false);
