...
void nano::scheduler::manual::push (std::shared_ptr<nano::block> const & block_a, std::optional<nano::uint128_t> const & previous_balance_a, nano::election_behavior election_behavior_a)
{
	nano::lock_guard<nano::mutex> lock{ mutex };
