...
private:
	...
	const std::chrono::milliseconds hinted_election_max_idle{ std::chrono::milliseconds (10 * 1000) };
	const std::chrono::milliseconds optimistic_election_max_idle{ std::chrono::milliseconds (10 * 1000) };
