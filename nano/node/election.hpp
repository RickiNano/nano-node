...
private:
	...
	std::chrono::milliseconds max_election_duration = std::chrono::milliseconds (10 * 60 * 1000);
	std::chrono::milliseconds max_idle_duration_normal = std::chrono::milliseconds (30 * 1000);
