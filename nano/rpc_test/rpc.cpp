...
TEST (rpc, online_reps)
{
	...
	// Wallet (1) auto-receives once the send is confirmed (see wallets::receive_confirmed);
	// calling receive_action directly here races with that auto-receive, so just wait.
